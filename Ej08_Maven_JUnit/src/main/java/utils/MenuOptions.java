...
import persistence.controller.CocheController;
...
public class MenuOptions {
	...
	public static void exportToExcel(CocheController cc) {
		boolean res = cc.exportToExcel();
		
		if(res) {
			System.out.println("Fichero Excel creado correctamente");
		} else {
			System.out.println("Ha ocurrido un error al crear el fichero Excel");
		}
	}
